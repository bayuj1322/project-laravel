    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-light-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="/assets/image/logo_sig.png" alt="SIG Logo" class="brand-image" style="opacity: .8">
                                ...
                                <div class="card-body table-responsive p-0">
                                    <table class="table table-striped table-valign-middle">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <img src="/assets/adminLTE/dist/img/default-150x150.png" alt="Product 1" class="img-circle img-size-32 mr-2">
                                                    Some Product
                                                </td>
                                                <td>$13 USD</td>
                                                <td>
